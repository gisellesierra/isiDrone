...
<div class="container">
    ...
    <form action="editProfile" method="post" class="panel panel-primary form-horizontal" style="float: unset; margin: auto;">
        <div class="panel-heading">
            <h3 class="panel-title">Modification de profile</h3>
        </div>
        <div class="panel-body">
            <fieldset class="col-sm-6 col-lg-6 col-md-6">
                ...
                <div  class="form-group">	
                    <div class="col-sm-10">
                        <label for="checkbox" class="col-sm-2 control-label" style="padding-top: 0px;">Change Password</label>
                        <input type="checkbox" id="checkbox"  name="checkbox" value="unchecked"  />
                    </div>
                </div>
                ...
                <div  class="form-group">	
                    <div class="col-sm-10">
                        ...
                        <input type="password" id="oldPassword" class="form-control" name="oldPassword" value="<%=Misc.getOrDefault(hm_formParamValue, "oldPassword", "")%>"  />
                    </div>
                </div>
                <%
                ...
                <script>
                    ...
                    let divElemt = document.getElementById("passwordchange");
                    divElemt.style.display = "none"
                    checkbox.addEventListener('change', function() {
                        if (this.checked) {
                          divElemt.style.display = "unset"
