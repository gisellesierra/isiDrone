...
import static action.ActionUsers.validateForm;
...
public class ActionEditProfile {
    ...
    public static boolean editProfile(User currUser, HttpServletRequest request, HttpServletResponse response) {
        ...
        String checkox = request.getParameter("checkbox");

        String[] s_formParamsNeeded = {"lastName", "firstName", "email",
            "addr_no", "addr_street", "addr_zip", "addr_city", "addr_state", "addr_country"},
                s_formParamsOptional = {"addr_appt", "oldPassword", "password", "confirmPassword"};
        ...
        String[] s_formValueOptional = {
            ...
            request.getParameter(s_formParamsOptional[1]),
            request.getParameter(s_formParamsOptional[2]),
            request.getParameter(s_formParamsOptional[3])
        };
        if (checkox != null) {
            s_formParamsNeeded = new String[]{"lastName", "firstName", "email", "addr_no", "addr_street", "addr_zip", "addr_city", "addr_state", "addr_country", "oldPassword", "password", "confirmPassword"};
            s_formParamsOptional = new String[]{"addr_appt"};

            s_formValuesNeeded = new String[]{
                request.getParameter(s_formParamsNeeded[0]),
                request.getParameter(s_formParamsNeeded[1]),
                request.getParameter(s_formParamsNeeded[2]),
                request.getParameter(s_formParamsNeeded[3]),
            ...
            s_formValueOptional = new String[]{
                request.getParameter(s_formParamsOptional[0])};
        }
        ...
        if (isCompleted) {
            ...
            address.setId(client.getShipAddress().getId());
            ...
            int rep = MUser.editProfileClient(user, false);
            ...
            if (rep < 1) {
                ...
                if (rep == 0) {
                    ...
                    hm_fieldErrorMsg.put("email", "Email Existe deja!!!");
                    request.setAttribute("hm_fieldErrorMsg", hm_fieldErrorMsg);
                    //request.setAttribute("error", "Email Existe deja!!!");
                } else if (rep == -1) {
    ...
    public static boolean validateForm(HashMap<String, String> hm_formParamValue, HttpServletRequest request) {
        ...
        if (request.getParameter("checkbox") != null) {
            ...
            validation.addRestriction("oldPassword", restrictPassword);
